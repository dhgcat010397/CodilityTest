...
if __name__ == "__main__":
    ...
    result_1 = task8.solution(5, 0, 2)
    result_2 = task8.solution(1, 2, 1)
    result_3 = task8.solution(0, 2, 0)
    result_4 = task8.solution(0, 0, 10)
    # result_5 = task8.solution(1, 1, 34)
    print(f"The longest string that can be created:")
    print(f'Given AA = 5, AB = 0, BB = 2, return: {result_1}')
    print(f'Given AA = 1, AB = 2, BB = 1, return: {result_2}')
    print(f'Given AA = 0, AB = 2, BB = 0, return: {result_3}')
    print(f'Given AA = 0, AB = 0, BB = 10, return: {result_4}')
    # print(f'Given AA = 0, AB = 0, BB = 10, return: {result_5}')
